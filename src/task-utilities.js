...
export default function taskUtil(){
    return {
        ...
        sortDates(tasksList){
            let sortedTaskList = orderBy(tasksList,['date','priority'],['asc','asc']);
            return sortedTaskList;
        },
        ...
        createTasksFromStorage(taskStringList){
            ...
            taskStringList.forEach((eachTask)=>{
                ...
                if(taskString.length!=0){
                    taskList.push(task(taskString[0],taskString[1],taskString[2],taskString[6],taskString[3],taskString[4],parseInt(taskString[5])));
                }
            });
            return taskList;
        },
